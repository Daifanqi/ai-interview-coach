...
language, roughly what to expect, that follow-ups are normal, and per
decision #17 item 2 that feedback is coming after each answer) so the
...
in backend/conversation/prompts/). The feedback mention is deliberately
just "I'll give you feedback after each answer" -- a user-visible behavior,
not "feedback has two parts: content and wording", which is an
implementation detail the product UI surfaces on its own (week 10).
"""
...
_OPENING_LINES: dict[tuple[Persona, Language], str] = {
    (Persona.FRIENDLY, "zh"): (
        ...
        "说得不好，放轻松就好。每次你回答完，我也会给你一点小反馈，希望"
        "能帮到你。准备好了我们就开始吧？"
    ),
    (Persona.FRIENDLY, "en"): (
        ...
        "anything was wrong with your answer. I'll also give you a bit of "
        "feedback after each answer along the way — hopefully useful. Take "
        "your time, and whenever you're ready, let's get started."
    ),
    (Persona.TECHNICAL, "zh"): (
        ...
        "每轮问答结束后，我也会给你一些反馈，帮你更清楚下次可以往哪个"
        "方向补充。准备好了吗？我们开始第一个问题。"
    ),
    (Persona.TECHNICAL, "en"): (
        ...
        "After each round I'll also share some quick feedback, so you can "
        "see where to add more detail next time. Ready? Let's start with "
        "the first question."
    ),
    (Persona.STRICT, "zh"): (
        ...
        "按照真实情况回答就可以。每轮回答之后，我也会给你一些反馈。我们"
        "开始吧。"
    ),
    (Persona.STRICT, "en"): (
        ...
        "the full picture. Just answer as accurately as you can, and I'll "
        "give you some feedback after each answer along the way. Let's "
        "begin."
    ),
}
